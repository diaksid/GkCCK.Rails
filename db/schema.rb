...
ActiveRecord::Schema.define(version: 2018_07_07_000080) do
  ...
  create_table "areas_throughs", force: :cascade do |t|
    ...
    t.index ["resource_type", "resource_id", "area_id"], name: "index_area_throughs_for_uniqueness", unique: true
  ...
  create_table "feedbacks", force: :cascade do |t|
    ...
    t.index ["index"], name: "index_feedbacks_on_index"
  ...
  create_table "partners", force: :cascade do |t|
    ...
    t.index ["affiliate"], name: "index_partners_on_affiliate"
    t.index ["index"], name: "index_partners_on_index"
    t.index ["name"], name: "index_partners_on_name", unique: true
    t.index ["navigated"], name: "index_partners_on_navigated"
  ...
  create_table "permits", force: :cascade do |t|
    ...
    t.index ["partner_id"], name: "index_permits_on_partner_id"
  ...
  create_table "targets", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["finish_at"], name: "index_targets_on_finish_at"
    ...
    t.index ["partner_id"], name: "index_targets_on_partner_id"
  ...
  add_foreign_key "feedbacks", "partners", on_delete: :nullify
  add_foreign_key "partners", "users", on_delete: :nullify
  add_foreign_key "permits", "partners", on_delete: :cascade
  add_foreign_key "targets", "partners", on_delete: :nullify
end
